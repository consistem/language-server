...
import { buildRoutineDocumentation, getRoutineSignatureDetails } from "../signatureHelp/routineSupport";
...
export async function getRoutineHover(
	...
	const routineDetails = await getRoutineSignatureDetails(doc, parsed, parenLine, parenToken, uri, server);
	...
	const docContent = buildRoutineDocumentation(routineDetails.signature, activeIndex, {
		context: "hover",
		showHeaderInHover: false,
	});
